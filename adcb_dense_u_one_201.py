...
model = densenet201(pretrained = False, num_classes = 5, last_activation = None, activations = "relu")
      ...
      if idx % 400 == 0:
         ...
         with torch.no_grad():    
              ...
              if best_val_auc < val_auc_mean:
                 ...
                 torch.save(model.state_dict(), '/user1/faculty/cvpr/ujjwal/Antik/Adaptive_Deformable_Densenet121/adcb_dense201_u_one.pth')
