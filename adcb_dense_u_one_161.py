...
model = densenet161(pretrained = False, num_classes = 5, last_activation = None, activations = "relu")
...
test_dataloader = DataLoader(dataset = test_set, batch_size = 8, shuffle = False)
...
set_seed(SEED)
checkpoint = torch.load("/user1/faculty/cvpr/ujjwal/Antik/Adaptive_Deformable_Densenet121/adcb_dense161_u_one.pth")
model.load_state_dict(checkpoint)
...
for epoch in range(100):
    ...
    for idx, data in enumerate(train_dataloader):
      ...
      train_data, train_labels  = train_data.to("cuda:0"), train_labels.to("cuda:0")
      ...
      if idx % 400 == 0:
         ...
         with torch.no_grad():    
              ...
              if best_val_auc < val_auc_mean:
                 ...
                 torch.save(model.state_dict(), '/user1/faculty/cvpr/ujjwal/Antik/Adaptive_Deformable_Densenet121/adcb_dense161_u_one.pth')
