...
from chexpert_preprocess import CheXpert
      ...
      if idx % 400 == 0:
         ...
         with torch.no_grad():    
              ...
              if best_val_auc < val_auc_mean:
                 ...
                 torch.save(model.state_dict(), '/user1/faculty/cvpr/ujjwal/Antik/Adaptive_Deformable_Densenet121/trained_models/adcb_dense121_u_zero_5labels.pth')
