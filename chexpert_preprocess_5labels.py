...
class CheXpert(Dataset):
    ...
    def __init__(self, 
                 ...
                 train_cols = ['Cardiomegaly', 'Edema', 'Consolidation', 'Atelectasis',  'Pleural Effusion'], #['No Finding','Enlarged Cardiomediastinum', 'Cardiomegaly', 'Lung Opacity','Lung Lesion', 'Edema', 'Consolidation', 'Pneumonia', 'Atelectasis','Pneumothorax', 'Pleural Effusion', 'Pleural Other', 'Fracture','Support Devices'],#
                 mode='train'):
